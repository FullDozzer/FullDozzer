...
- `/schedule` — показать расписание на завтра сразу (как изображение)
- `/checknow` — немедленно проверить изменения (при изменении отправит картинку)
- `/scheduletext` — получить расписание на завтра обычным текстом
- Кнопка `📝 Получить расписание текстом` — быстрый текстовый запрос (если картинки в Telegram грузятся плохо)
